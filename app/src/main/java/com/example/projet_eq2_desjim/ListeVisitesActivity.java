...
public class ListeVisitesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listViewReleves = findViewById(R.id.listvisite);
        ...
        DaoVisite.open();
            ...
            Cursor c = DaoVisite.getDataVisite();
            ...
            int[] to = new int[]{R.id.textID, R.id.textNomEtudiant, R.id.textNomTuteur, R.id.textNomProf, R.id.textDate};
