...
public class ListeProfesseursActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_listeprofs);
        ...
        Cursor c = DaoEntreprises.getDataProfesseur();

        // colonnes à afficher
        String[] columns = new String[]{bddDAO.COL_ID_PROFESSEUR, bddDAO.COL_NOM_PROFESSEUR, bddDAO.COL_PRENOM_PROFESSEUR, bddDAO.COL_EMAIL_PROFESSEUR, bddDAO.COL_NUMTEL_PROFESSEUR};
        ...
        SimpleCursorAdapter dataAdapter = new SimpleCursorAdapter(this, R.layout.layout_listeprofs, c, columns, to, 0);
