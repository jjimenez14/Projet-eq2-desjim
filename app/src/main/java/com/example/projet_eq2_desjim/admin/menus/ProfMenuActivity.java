...
import com.example.projet_eq2_desjim.admin.ajouter.AjouterProfActivity;
...
public class ProfMenuActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_menuprofs);
        ...
        View.OnClickListener ecouteur = new View.OnClickListener(){
            public void onClick(View v){
                switch(v.getId()) {
                    case R.id.button4:
                        startActivity(new Intent(ProfMenuActivity.this, ListeProfesseursActivity.class));
                        break;
                    case R.id.button5:
                        startActivity(new Intent(ProfMenuActivity.this, AjouterProfActivity.class));
                        break;
                    case R.id.button6:
                        startActivity(new Intent(ProfMenuActivity.this, AdminMenuActivity.class));
                        break;
                }
            }
        };
