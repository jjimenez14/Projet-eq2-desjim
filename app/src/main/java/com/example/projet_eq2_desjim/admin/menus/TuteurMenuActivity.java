...
import com.example.projet_eq2_desjim.admin.ajouter.AjouterTuteurActivity;
...
public class TuteurMenuActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_menututeurs);
        ...
        View.OnClickListener ecouteur = new View.OnClickListener(){
            public void onClick(View v){
                switch(v.getId()) {
                    case R.id.button4:
                        startActivity(new Intent(TuteurMenuActivity.this, ListeTuteursActivity.class));
                        break;
                    case R.id.button5:
                        startActivity(new Intent(TuteurMenuActivity.this, AjouterTuteurActivity.class));
                        break;
                    case R.id.button6:
                        startActivity(new Intent(TuteurMenuActivity.this, AdminMenuActivity.class));
                        break;
                }
            }
        };
